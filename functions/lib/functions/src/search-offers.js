...
exports.searchOffers = (0, https_1.onCall)({ region: "us-central1" }, async (request) => {
    ...
    if (!skyscannerApiKey) {
        throw new https_1.HttpsError("failed-precondition", "Missing SKYSCANNER_API_KEY in Firebase Functions environment.");
    }
    ...
    const [flights, hotels] = await Promise.all([
        (0, skyscanner_1.searchSkyscannerFlightOffers)({
            adults,
        ...
        (0, skyscanner_1.searchSkyscannerHotelOffers)({
            adults,
            apiKey: skyscannerApiKey,
            checkInDate: parseIsoDate(departureDate),
            checkOutDate: parseIsoDate(returnDate),

...
function getPlaceholder(step: HomePlannerStep, language: "bg" | "en" | "de" | "es" | "fr") {
  ...
  if (language === "fr") {
    if (step === "done") return "Ajuste le plan ou ecris generate again...";
    if (step === "chatting") return "Dis-moi quel type de voyage tu veux...";
    return "Ecris un message...";
  }
        ...
        <TextInput
          ...
          placeholder={
            voiceListening
              ...
              : planning
                ? planningLabel ??
                  (step === "done" ? t("home.searchingPrices") : t("home.aiThinking"))
        ...
        <TouchableOpacity
          ...
          style={[
            styles.actionButton,
            {
              ...
              borderColor: canSend ? colors.accent : colors.disabledBackground,
            },
          ]}
          onPress={onSend}
          disabled={!canSend}
